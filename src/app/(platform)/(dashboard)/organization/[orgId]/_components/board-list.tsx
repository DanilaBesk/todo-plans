      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {boards.map((board) => (
          <Link
            ...
            className="group aspect-video bg-cover bg-no-repeat bg-center relative bg-sky-700 rounded-sm w-full h-full p-2 overflow-auto"
            href={`/board/${board.id}`}
          >
...
BoardList.Skeleton = function Skelet() {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
